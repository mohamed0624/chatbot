...
import 'package:chatbot/screens/registration_screen.dart';
...
class _WelcomeScreenState extends State<WelcomeScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = ColorTween(begin: Colors.red, end: Colors.red.shade50).animate(
        controller);
    controller.forward();
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(onPressed: () {
              Navigator.pushNamed(context, RegistrationScreen.regis);
